  ...
  return (
    <>
      ...
      <CardDescription className={cn('mb-2')}>
        Read input from <span className={cn('font-mono text-xs')}>`{privacyFormFilePath}`</span> and{' '}
        <span className={cn('font-mono text-xs')}>`{surveyFilePath}`</span>.
      </CardDescription>
      <CardDescription className={cn('mb-2')}>
        Processed a total of {totalUniqueIdentifiers} unique study codes in {totalEntries} entries ({totalDuplicates}{' '}
        duplicates):
      ...
      <CardDescription className={cn('mb-6')}>
        Output files written to <span className={cn('font-mono text-xs')}>`{outputDirectoryPath}`</span>.
      </CardDescription>
