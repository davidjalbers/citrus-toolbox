  ...
  return (
    <Card className={cn("m-5 p-8 text-center text-destructive")}>
      ...
      <p className={cn("mb-4")}>
        ...
        Please ensure that the input files are valid and readable and then try again. 
        If the error persists, please report it including the below stack trace.
      </p>
      <p className={cn("mb-8")}>
        <span className={cn("font-mono")}>{error.toString()}</span>
        <br />
        <Button variant="link" className={cn("text-destructive")} onClick={() => {
